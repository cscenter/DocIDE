...
public class RDRestrictionImpl extends ASTWrapperPsiElement implements RDRestriction {

  public RDRestrictionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RDVisitor) ((RDVisitor)visitor).visitRestriction(this);
